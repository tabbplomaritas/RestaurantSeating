...
$("#floorPlan").on('mouseenter', '.reserved', function(){ 
  let clickedItem = this.id;
console.log("i'm mousing over a reserved element");
  //check that number against all the booked tables in our reservation array
...
//   if (checkItem.hasClass("reserved")) {
//     let clickedItem = this.id;
...
$("#floorPlan").on('mouseleave', '.reserved', function(){
    let popUpDiv = ($(this).find('.popUp'));
